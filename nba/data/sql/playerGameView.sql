...
SELECT name, teamAbrv as team, game_number,season,home,
plogs.*,opp.*,
--last games played
...
INNER JOIN 
    (SELECT team_id as opp_id,game_id, ra_fga as ra_fgallowed, paint_fga as paint_fgallowed, mid_fga as mid_fgallowed, lc_fga as lc_fgallowed, rc_fga as rc_fgallowed, abv_fga as abv_fgallowed, open_fg3a, wide_fg3a, open_fg2a, wide_fg2a, 
    --oepn shot rates
